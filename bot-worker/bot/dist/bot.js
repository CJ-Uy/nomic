...
export async function botJoin(guildId, userId, interactionToken, appId) {
    try {
        ...
        await sendFollowup(interactionToken, appId, `Joined **${voiceChannel.name}**! Type in the voice chat and I'll read it aloud.`);
    }
    catch (err) {
